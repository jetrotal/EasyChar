...
getQuery('body-type',"#qtd").value <= 2) ? 
    charData.layers[n].bmp.y = (charData.layers[n].img.getAttribute('class') !=="clothes" && document.getElementById("body-type").querySelector(".spriteSel").value == 2 ? charData.yOffset.adultNew: -1) :  charData.yOffset.adult : 
